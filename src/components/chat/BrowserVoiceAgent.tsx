  ...
  return (
    <Card className="w-full max-w-md mx-auto border-primary/20 shadow-lg">
      <CardHeader className="text-center pb-2">
        ...
        <p className="text-xs text-muted-foreground">Free • Browser-powered • No API key needed</p>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {/* Live partial text */}
        {partialText && (
          <div className="px-3 py-2 bg-primary/5 rounded-lg text-sm text-primary italic text-center">
            {partialText}...
          </div>
        )}
        ...
        {/* Transcript */}
        {transcript.length > 0 && (
          <div className="max-h-40 overflow-y-auto p-3 bg-muted/50 rounded-lg text-sm space-y-2">
        ...
        <p className="text-xs text-center text-muted-foreground">
          Uses your browser's built-in voice recognition & synthesis
        </p>
      </CardContent>
    </Card>
  );
